...
char base_link_name[] = "/mantis/base_link";
char odom_name[] = "/mantis/base";

ros::Publisher ros_odom("/mantis/pose2d", &pose2d);
...
ros::Subscriber<geometry_msgs::Twist> sub("/mantis/cmd_vel", &cmd_vel_handle );
